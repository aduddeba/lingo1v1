...
export const SCRIPT_BLITZ_QUESTIONS: ScriptBlitzQuestion[] = [
  ...
  { id: 'sb-slk-001', category: 'language', displayText: 'Dobrý deň', answer: 'Slovak', aliases: ['slovensky', 'slovak language', 'slovenčina'], hint: 'Good day — deň uses ň, unique to Slovak', difficulty: 'medium' },
